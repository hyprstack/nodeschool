//Objective - Send an HTTP POST request to http://localhost:8000 and pipe process.stdin into
//it. Pipe the response stream to process.stdout.

var request = require('request');
//make a post request
var r = request.post('http://localhost:8000');
//pipe a readable stream into process.stdin and pipe a writable stream out to process.stdout
